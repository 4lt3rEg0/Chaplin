// VELOCITY COCKPIT — automotive/aviation instrument cluster. Panel and gauge
// face stay dark carbon regardless of mode; needle/tick/accent tokens are
// what "sync with theme" actually moves, keeping the dashboard read intact.
