...
// BookEditor.jsx). On success this hands off straight into the existing
// full-screen BookEditor.jsx, so the whole "name your book -> write it"
// journey stays full-screen end to end without building a new writing
// surface here.
...
export default function NewBook() {
  ...
  return (
    <Shell>
      ...
      <Body>
        <NewBookForm onSuccess={(book) => navigate(`/books/${book.id}`)} />
      </Body>
    </Shell>
  );
}
